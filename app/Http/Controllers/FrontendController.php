...
class FrontendController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($check){
            return redirect()->back()->with('errmessage','You already made an appointment, Please wait some time to make another request!');
        }
        Booking::create([
    ...
    {
        $appointments = Booking::with('doctor')->where('user_id',auth()->user()->id)->get();
